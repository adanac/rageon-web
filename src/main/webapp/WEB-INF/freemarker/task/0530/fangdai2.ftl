      		...
      		<div class="count">
      	    	...
      	    	<ol>
        				<li class="clear">
        					...
        					<div class="ret" data-type="area">
        						...
        						<select class="da pp-wprice" value="92.00" data-price="9500">2居2厅1卫  92.00平
        												<option value="92.00" data-price="9500">2居2厅1卫  92.00平</option>
        												
                              							<option value="92.00" data-price="9500">2居2厅1卫  92.00平</option>
        			
                              							<option value="109.00" data-price="9500">3居2厅2卫  109.00平</option>
        			
                              							<option value="120.00" data-price="9500">3居2厅2卫  120.00平</option>
        			
                              							<option value="125.00" data-price="9500">3居2厅2卫  125.00平</option>
        			
                              							<option value="144.00" data-price="9500">4居2厅2卫  144.00平</option>
        			
                              							<option value="152.00" data-price="9500">4居2厅2卫  152.00平</option>
                ...
                <li class="clear">
                  ...
                  <div class="ret" data-type="percent">
                    <span class="da chengshu-value" value="0.7">7成</span>
                ...
                <li class="clear">
                  ...
                  <div class="ret" data-type="rate">
                    <span class="da" value="0.0325">公积金贷款</span>
                    <span class="arrow"></span>
                    <ol class="dk-type" style="display: none;">
                      <li value="0.0325">公积金贷款</li>
                      <li value="0.04635">商业贷款</li>
                      <li>组合贷款</li>
                    </ol>
                  </div>
                </li>
                ...
                <div id="dk-list" style="display:none">
                  <li class="clear">
                    ...
                    <div class="ret-zongjia" data-type="accurate">
                      <input class="da" id="accu-dk" value="0.0325">
                      <span class="wan">万</span>
                    </div>
                  </li>
                  <li class="clear">
                    ...
                    <div class="ret-zongjia" data-type="bnsrate">
                      <input class="da" id="bns-dk" value="0.04635">
                      <span class="wan">万</span>
                    </div>
                  </li>
                </div>
                ...
                <li class="clear">
                  ...
                  <div class="ret" data-type="times">
                    <span class="da" value="360">30年（360期）</span>
                    <span class="arrow"></span>
                    <ol>
                      <li value="12">1年（12期）</li>
                      <li value="24">2年（24期）</li>
                      <li value="36">3年（36期）</li>
                      <li value="48">4年（48期）</li>
                      <li value="60">5年（60期）</li>
                      <li value="72">6年（72期）</li>
                      <li value="84">7年（84期）</li>
                      <li value="96">8年（96期）</li>
                      <li value="108">9年（108期）</li>
                      <li value="120">10年（120期）</li>
                      <li value="132">&gt;11年（132期）</li>
                      <li value="144">&gt;12年（144期）</li>
                      <li value="156">&gt;13年（156期）</li>
                      <li value="168">&gt;14年（168期）</li>
                      <li value="180">&gt;15年（180期）</li>
                      <li value="192">&gt;16年（192期）</li>
                      <li value="204">&gt;17年（204期）</li>
                      <li value="216">&gt;18年（216期）</li>
                      <li value="228">&gt;19年（228期）</li>
                      <li value="240">&gt;20年（240期）</li>
                      <li value="252">&gt;21年（252期）</li>
                      <li value="264">&gt;22年（264期）</li>
                      <li value="276">&gt;23年（276期）</li>
                      <li value="288">&gt;24年（288期）</li>
                      <li value="300">&gt;25年（300期）</li>
                      <li value="312">&gt;26年（312期）</li>
                      <li value="324">&gt;27年（324期）</li>
                      <li value="336">&gt;28年（336期）</li>
                      <li value="348">&gt;29年（348期）</li>
                      <li value="360">&gt;30年（360期）</li>
                    </ol>
                  </div>
                </li>
