                                ...
                                <div class="tab-content">
									<div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="row">
			                                    ...
			                                    <div class="col-md-12 col-sm-12 ta_l">
                                                                                                       
			                                        <div id="" class="f_l">
                                                        
                                                        <div class="page-title f_l ma_b0 pa_r15">
                                                        
                                                            <label class="f_l pa_t2 ma_r10">批量设置：</label>
                                                            <label class="f_l ma_r5">
                                                            <small>限时折扣&nbsp;
                                                                <input type="text" class="form-control input-inline input-sm input-xsmall" id="zk" placeholder="请输入">&nbsp;折</small>
                                                            <small>每人限购数
                                                                <input type="text" class="form-control input-inline input-sm input-xsmall" id="xg" placeholder="不限"></small>
                                                            </label>
                                                            <button type="button" class="btn blue-madison f_l ma_b5 ma_l10" onclick="set()">设置</button>
                                                        </div>
                                                    </div>     
                                                    <div class="f_r">
											...
											<table id="goods_list" data-side-pagination="server" data-pagination="true" data-height="" class="table table-striped table-bordered table-hover dataTable no-footer ta_c" style="width: 100%;border:1px solid #ddd;">
											</table>
...
<script src="${resRoot}/pages/sale/xs/activityGood/priceDiscount.js" type="text/javascript"></script>    
<script>
