    ...
    function(t) {
        ...
        function() {
            var i = {
                ...
                $oojs: function() {
                    var i = {};
                    if ("undefined" != typeof window && "undefined" != typeof document ? (this.runtime = "browser", i.global = window) : (this.runtime = "node", i.global = t), i.proxyName = "proxy", i.path = "node" === this.runtime ? process.cwd() + "/src/": "/src/", "undefined" != typeof e) for (var n in e) n && e.hasOwnProperty(n) && (i[n] = e[n]);
                ...
                define: function(t) {
                    ...
                    for (var n, o = !1,
                    r = !1,
                    a = i.split("."), s = a.length, d = this.classes, l = 0; s > l; l++) n = a[l],
                    n && (d[n] = d[n] || {},
                    d = d[n]);
                    d[e] = d[e] || {};
                    var c = d;
    ...
    function(t) {
        ...
        t.define({
            ...
            assert: function(t) {
                ...
                i = e.basic,
                n = e.container;
                return 1 !== i.rspFormat || 2 !== i.flowType || 3 !== n.anchoredType && 11 !== n.anchoredType ? !1 : !0
            }
        }),
        t.define({
            name: "storage",
        ...
        t.define({
            ...
            md5: function(t) {
                ...
                function s(t, o, r, a, s, d, l) {
                    return t = i(t, i(i(n(o, r, a), s), l)),
                    i(e(t, d), o)
                }
                function d(t, n, r, a, s, d, l) {
                    return t = i(t, i(i(o(n, r, a), s), l)),
                    i(e(t, d), n)
                }
                function l(t, n, o, a, s, d, l) {
                    return t = i(t, i(i(r(n, o, a), s), l)),
                    i(e(t, d), n)
                }
                function c(t, n, o, r, s, d, l) {
                    return t = i(t, i(i(a(n, o, r), s), l)),
                    i(e(t, d), n)
                }
                function h(t) {
                    for (var e, i = t.length,
                    n = i + 8,
                    o = (n - n % 64) / 64, r = 16 * (o + 1), a = Array(r - 1), s = 0, d = 0; i > d;) e = (d - d % 4) / 4,
                    s = d % 4 * 8,
                    a[e] = a[e] | t.charCodeAt(d) << s,
                    d++;
                    return e = (d - d % 4) / 4,
                    s = d % 4 * 8,
                    a[e] = a[e] | 128 << s,
                ...
                F = 15,
                R = 21;
                for (t = p(t), S = h(t), w = 1732584193, b = 4023233417, I = 2562383102, _ = 271733878, m = 0; m < S.length; m += 16) f = w,
                g = b,
                y = I,
                v = _,
                w = s(w, b, I, _, S[m + 0], T, 3614090360),
                _ = s(_, w, b, I, S[m + 1], C, 3905402710),
                I = s(I, _, w, b, S[m + 2], x, 606105819),
                b = s(b, I, _, w, S[m + 3], A, 3250441966),
                w = s(w, b, I, _, S[m + 4], T, 4118548399),
                _ = s(_, w, b, I, S[m + 5], C, 1200080426),
                I = s(I, _, w, b, S[m + 6], x, 2821735955),
                b = s(b, I, _, w, S[m + 7], A, 4249261313),
                w = s(w, b, I, _, S[m + 8], T, 1770035416),
                _ = s(_, w, b, I, S[m + 9], C, 2336552879),
                I = s(I, _, w, b, S[m + 10], x, 4294925233),
                b = s(b, I, _, w, S[m + 11], A, 2304563134),
                w = s(w, b, I, _, S[m + 12], T, 1804603682),
                _ = s(_, w, b, I, S[m + 13], C, 4254626195),
                I = s(I, _, w, b, S[m + 14], x, 2792965006),
                b = s(b, I, _, w, S[m + 15], A, 1236535329),
                w = d(w, b, I, _, S[m + 1], O, 4129170786),
                _ = d(_, w, b, I, S[m + 6], E, 3225465664),
                I = d(I, _, w, b, S[m + 11], P, 643717713),
                b = d(b, I, _, w, S[m + 0], D, 3921069994),
                w = d(w, b, I, _, S[m + 5], O, 3593408605),
                _ = d(_, w, b, I, S[m + 10], E, 38016083),
                I = d(I, _, w, b, S[m + 15], P, 3634488961),
                b = d(b, I, _, w, S[m + 4], D, 3889429448),
                w = d(w, b, I, _, S[m + 9], O, 568446438),
                _ = d(_, w, b, I, S[m + 14], E, 3275163606),
                I = d(I, _, w, b, S[m + 3], P, 4107603335),
                b = d(b, I, _, w, S[m + 8], D, 1163531501),
                w = d(w, b, I, _, S[m + 13], O, 2850285829),
                _ = d(_, w, b, I, S[m + 2], E, 4243563512),
                I = d(I, _, w, b, S[m + 7], P, 1735328473),
                b = d(b, I, _, w, S[m + 12], D, 2368359562),
                w = l(w, b, I, _, S[m + 5], k, 4294588738),
                _ = l(_, w, b, I, S[m + 8], L, 2272392833),
                I = l(I, _, w, b, S[m + 11], U, 1839030562),
                b = l(b, I, _, w, S[m + 14], B, 4259657740),
                w = l(w, b, I, _, S[m + 1], k, 2763975236),
                _ = l(_, w, b, I, S[m + 4], L, 1272893353),
                I = l(I, _, w, b, S[m + 7], U, 4139469664),
                b = l(b, I, _, w, S[m + 10], B, 3200236656),
                w = l(w, b, I, _, S[m + 13], k, 681279174),
                _ = l(_, w, b, I, S[m + 0], L, 3936430074),
                I = l(I, _, w, b, S[m + 3], U, 3572445317),
                b = l(b, I, _, w, S[m + 6], B, 76029189),
                w = l(w, b, I, _, S[m + 9], k, 3654602809),
                _ = l(_, w, b, I, S[m + 12], L, 3873151461),
                I = l(I, _, w, b, S[m + 15], U, 530742520),
                b = l(b, I, _, w, S[m + 2], B, 3299628645),
                w = c(w, b, I, _, S[m + 0], M, 4096336452),
                _ = c(_, w, b, I, S[m + 7], N, 1126891415),
                I = c(I, _, w, b, S[m + 14], F, 2878612391),
                b = c(b, I, _, w, S[m + 5], R, 4237533241),
                w = c(w, b, I, _, S[m + 12], M, 1700485571),
                _ = c(_, w, b, I, S[m + 3], N, 2399980690),
                I = c(I, _, w, b, S[m + 10], F, 4293915773),
                b = c(b, I, _, w, S[m + 1], R, 2240044497),
                w = c(w, b, I, _, S[m + 8], M, 1873313359),
                _ = c(_, w, b, I, S[m + 15], N, 4264355552),
                I = c(I, _, w, b, S[m + 6], F, 2734768916),
                b = c(b, I, _, w, S[m + 13], R, 1309151649),
                w = c(w, b, I, _, S[m + 4], M, 4149444226),
                _ = c(_, w, b, I, S[m + 11], N, 3174756917),
                I = c(I, _, w, b, S[m + 2], F, 718787259),
                b = c(b, I, _, w, S[m + 9], R, 3951481745),
                w = i(w, f),
                b = i(b, g),
                I = i(I, y),
                _ = i(_, v);
                ...
                H = ((parseInt("0x" + u(w), 16) + parseInt("0x" + u(b), 16)) % 4294967296).toString(16),
                j = ((parseInt("0x" + u(I), 16) + parseInt("0x" + u(_), 16)) % 4294967296).toString(16);
                return H.length < 8 && (H = W(H)),
                j.length < 8 && (j = W(j)),
                H + j
            }
        }),
        ...
        t.define({
            ...
            LOG_URL: "//cbjslog.baidu.com/log",
            CACHE_URL: "//snippet.pos.baidu.com/bfp/snippetcacher.php?",
            STATUS_CREATE: 1,
            STATUS_REQUEST: 2,
            STATUS_RESPONSE: 4,
            STATUS_RENDERED: 8,
            ...
            $config: function() {
                i && (this.DUP_PREFIX = i),
                n && (this.LOADER_DEFINE_NAME = n),
                this.HTP_PROTOCOL = "https:" === location.protocol ? !0 : !1,
                this.POS_URL || (this.IS_STORAGE = this.storage.available(), this.shieldPath())
            },
            shieldPath: function() {
                var t = this.getWord();
            ...
            expTactics: function() {
                var t = 100 - this.SHUNT_NUMBER,
                e = 1e9 * Math.random();
                e < 1e7 * this.SHUNT_NUMBER && (this.EXP_SATUS = !0, this.EXP_ID = this.RD_ID),
                e >= 1e7 * t && (this.BASE_SATUS = !0, this.EXP_ID = this.BASE_ID)
            }
        }),
        t.define({
            name: "dom",
        ...
        t.define({
            ...
            queryToJson: function(t) {
                for (var e, i, n, o, r = t.substr(t.indexOf("?") + 1), a = r.split("&"), s = a.length, d = {},
                l = 0; s > l; l++) o = a[l].split("="),
                e = o[0],
                i = o[1],
                n = d[e],
        ...
        t.define({
            ...
            getOrientationQuery: function(t) {
                ...
                for (var r = "",
                a = i.length,
                s = 0; a > s && !(r.length + i[s].length >= t); s++) r += (s ? "&": "") + i[s];
                return r
            },
        ...
        t.define({
            ...
            },
            {
                key: "prot",
                value: function() {
                    return this.config.HTP_PROTOCOL ? "2": ""
                }
            },
            {
                key: "ltu",
        ...
        t.define({
            ...
            validate: function(t, e, i, n, o) {
                ...
                return ! d && l ? r = parseInt(s.imgWidth, 10) === parseInt(t, 10) && parseInt(s.imgHeight, 10) === parseInt(e, 10) : d && c && this.isAvalibleTextSize(t, e) && (r = !0),
                r
            },
            ...
            getPreviewUrl: function(t, e, i, n) {
                ...
                d = "";
                return n.indexOf("inlay") >= 0 ? d = this.getInlayUrl(parseInt(s.type, 10), r, a, "text_default_" + t + "_" + e) : n.indexOf("float") >= 0 && (d = this.getFloatUrl(parseInt(s.type, 10), r, a)),
                d
            },
            getPrevValue: function(t, e) {
                ...
                return i.indexOf(r) > -1 && (a = this.url.getQueryValue(i, r)),
                !a && n && -1 !== n.indexOf(r) && (a = this.cookie.get(r)),
                a || -1 === o.indexOf(r) || (a = this.url.getQueryValue(o, r)),
                a
            },
        ...
        t.define({
            ...
            getSlotType: function(t) {
                ...
                if (!i) return e;
                var n = i.placement;
                if ((this.inlayFixAssert.assert(i) || this.dynamicFloatAssert.assert(i)) && (e = this.TYPE.INLAY), n && n.fillstyle) for (var o = i.placement.fillstyle.elements || [], r = 0, a = o.length; a > r; r++) if (5 === o[r]) return this.TYPE.LINKUNIT;
                return e
            }
        }),
        t.define({
        ...
        t.define({
            ...
            validate: function(t) {
                var e = t.styleOpenApi.cpro_enable_hidden_float ? !0 : !1,
        ...
        t.define({
            ...
            monitorLog: function(t) {
                ...
                s = t.mes ? t.mes: "",
                d = t.exps ? t.exps: "";
                e = this.config.LOG_URL + ["?type=" + o, "id=" + i, "error=" + r, "status=" + a, "async=" + n, "mes=" + s, "exps=" + d, "from=ssp", "tm=" + +new Date].join("&"),
        ...
        t.define({
            ...
            getPainter: function(e) {
                ...
                for (var n = e.response,
                o = ["dan.static", "dan.couplet", "dan.expand", "dan.barrier", "dan.video", "topSearchBar", "bottomSearchBar", "slide", "inlayFix", "baiduRec", "dynamicFloat", "float", "insideText", "mobile.inlayFix", "mobile.float"], r = 0, a = o.length; a > r; r++) {
        ...
        t.define({
            ...
            processExtendsParam: function(t) {
                ...
                if (a && a.hasOwnProperty("cbcw") && a.hasOwnProperty("cbch")) {
                    ...
                    if (u && p && (i.width = u, i.height = p), m > 0 && (i.sizeType = m), 1 === m) t.width = u,
                    t.height = p;
                    else if (2 === m) {
            ...
            getPmpRequestUrl: function(t) {
                ...
                if (l) {
                    ...
                    i.push("dc=2"),
                    r && a > 0 && (e.tt = a + "." + (s - a) + "." + (d - a) + "." + ( + new Date - a)),
                    e.exps && (i.push("exps=" + e.exps), e.exps = "")
                } else e.dcf = 1,
                r && a > 0 && (e.tt = a + ".0.0." + ( + new Date - a), e.feid = "7401");
                var w = i.join("&");
        ...
        t.define({
            ...
            requestSlotInfo: function(t) {
                ...
                t.isAsync === !0 && (o = !0),
                this.config.EXP_SATUS,
                e || (this.sendJsonpRequest(n, o), this.setStatus(t.id, this.config.STATUS_REQUEST))
            },
            localAdInfo: function(t) {
                if (!this.config.IS_STORAGE || this.config.IS_STORAGE && !this.storage.getItem(t.id) || JSON && JSON.parse) return ! 1;
                var e = +new Date,
                i = JSON.parse(this.storage.getItem(t.id));
                if (!i.lifeDate) return ! 1;
                var n = e - i.lifeDate;
                return n > this.config.STORAGE_TIMER ? (localStorage.removeItem(t.id), !1) : (this.setStatus(t.id, this.config.STATUS_REQUEST), window[this.config.LOADER_DEFINE_NAME](i), !0)
            },
            ...
            renderFrame: function(t, e) {
                ...
                if (i && !this.slot.checkStatus(i, this.config.STATUS_FINISH)) {
                    ...
                    try {
                        ...
                        a.write(r),
                        a.close(),
                        a.body && (a.body.style.backgroundColor = "transparent")
                    } catch(s) {
                        this.log.monitorLog({
                            id: t,
                            error: "frameFail",
        ...
        t.define({
            ...
            validate: function(t) {
                if ("union" === t.productLine) {
                    var e = this.deliveryLimit.TYPE.POPUP; ("couplet" === t.blockType || "button" === t.blockType) && (e = this.deliveryLimit.TYPE.COUPLET);
            ...
            createCloseElement: function(t) {
                ...
                e.button = e.popup = function() {
                    ...
                    n = "\\u5FAE\\u8F6F\\u96C5\\u9ED1",
                    a = "\\u5173\\u95ED",
                    s = ["box-sizing: content-box;", "position:absolute;width:" + e + "px;", "height:20px;top:0;", "left:" + i + "px;", "margin:0;padding:0;margin-bottom:5px;", "cursor:pointer;overflow:hidden;"].join(""),
                    d = ['<div id="' + o + '" style="' + s + '">', '<div style="', "box-sizing: content-box;", "width:40px;height:20px;", "background-color:#999999;", "color:#fff;float:left;", "margin-right:1px;font-size:12px;", "font-family:" + r.unicode.toDecode(n) + ";", "text-align: center;line-height:20px;", '">' + r.unicode.toDecode(a) + "</div>", '<a style="maring:0;padding:0;', "display:inline-block;border:none;", "overflow:hidden;height:20px;", "line-height:20px;cursor:pointer;", "width:20px;background:url(", "'//cpro.baidustatic.com/cpro/ui/", "noexpire/img/2.0.1/xuanfu_close.png", "') no-repeat 0 0;margin-bottom:3px;", 'float:left" ></a>', "</div>"].join("");
                    return d
                },
                e["default"] = function() {
            ...
            createContainerElementByInfo: function(t) {
                ...
                if (1 === t.followType) if (this.style.canFixed()) {
                    ...
                    i.push(n.cssName + ":" + n.cssValue + "px;"),
        ...
        t.define({
            ...
            processSlotInfo: function(t) {
                ...
                e.height = a;
                    ...
                    n.height = t.height = e.height = a
                }
                e.sizeType = o;
                var m = t.styleOpenApi,
                f = m.cpro_w || m.rsi0 || 0,
                g = m.cpro_h || m.rsi1 || 0;
                return (f || g) && (e.width = f || this.getCurViewportWidth(r), e.height = g || a, t.width = e.width, t.height = e.height),
                e
            },
                ...
                if (this.slot.setStatus(t.id, this.config.STATUS_RENDERED), this.validate(t)) {
                    ...
                    if (e) {
                        ...
                        if (this.decorateContainer(e, o), t.width = o.width, t.height = o.height, 2 === o.sizeType || 5 === o.sizeType) {
                            ...
                            if (r && r._html) {
                                r = r._html;
                                var a = r.type; ("text" === a || "image" === a || "flash" === a) && (r.width = t.width, r.height = t.height)
                            }
                        }
                        var s = {
                            id: t.id,
                    ...
                    if (!n) {
                        ...
                        if (o) {
                            ...
                            if (2 === i.sizeType) {
                                ...
                                if (a && a._html) {
                                    a = a._html;
                                    var s = a.type; ("text" === s || "image" === s || "flash" === s) && (a.width = e.width, a.height = e.height)
                                }
                            }
                            var d = {
                                id: e.id,
                ...
                if (this.validate(e)) {
                    ...
                    if (!i) {
                        ...
                        if (6 === a) {
                            ...
                            s.response.placement.container.location = 5,
                            s.containerId = s.containerId + "_right",
                            this.slot.addSlot(s),
                            n.push(s),
                            e.response.placement.container.location = 4,
                            e.containerId = e.containerId + "_left"
                        }
                        for (var d = 0,
                        l = n.length; l > d; d++) {
                            var c = n[d],
        ...
        var o = t.using("dup.ui.delivery.main");
        o.process()
    } (_ssp_global.oojs)
} catch(e) {
    var purl = window.location.href || "null",
    url = ["//cbjslog.baidu.com/log?", "type=fatalError", "mes=" + decodeURIComponent(e), "purl=" + purl].join("&"),
    img = new Image;
    img.src = url
}