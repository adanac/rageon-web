    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
            ...
            $('#style_color').attr("href", Layout.getLayoutCssPath() + 'themes/' + color_ + ".css");
                // console.log(Layout.getLayoutImgPath());
            if (color == 'light2') {
                $('.page-logo img').attr('src', Layout.getLayoutImgPath_new() + 'logo-invert.png');
            } else {
                $('.page-logo img').attr('src', Layout.getLayoutImgPath_new() + 'logo.png');
            }
        };
