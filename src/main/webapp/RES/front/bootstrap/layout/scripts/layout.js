...
var Layout = function () {
    ...
    var layoutImgPath_new = 'admin/new/images/';

    var layoutCssPath_new = 'admin/new/css/';
    ...
    return {
        ...
        getLayoutImgPath_new: function () {
            return Metronic.getAssetsPath() + layoutImgPath_new;
        },

        getLayoutCssPath_new: function () {
            return Metronic.getAssetsPath() + layoutCssPath_new;
        }
    };
