        ...
        o = function() {
            ...
            function(e, a) {
                ...
                if (o) {
                    ...
                    l = c + o.height(); (c >= 0 && n > c || l > 0 && n >= l) && (s ? "img" === i ? r(o.attr("src", s)) : o.load(s, {},
                    function() {
                        r(o)
                    }) : r(o), a.obj = null)
                }
...
$.loadScript = function(e) {
    function t() {
        return r ? !1 : (r = !0, o.onload = null, o.onerror = null, a.complete && a.complete(), s.resolve(), void i.removeChild(o))
    }
    function n() {
        return r ? !1 : (r = !0, a.fail && a.fail(), i.removeChild(o), void s.reject())
    }
    var a = {
        url: "",
        charset: "utf-8",
...
var Pagination = function(require) {
    function e(e, t, n) {
        var a = [];
        if (n = n || 6, t = t || 1, n >= e) for (var r = 0; e > r; r++) a.push(r + 1);
        else {
            a.push(1),
            t > 4 && a.push("");
            for (var o = Math.max(t - 2, 2), i = Math.min(t + 2, e - 1), r = o; i >= r; r++) a.push(r);
            e - 3 > t && a.push(""),
            a.push(e)
        }
        return a
    ...
    function t(e, t, n, a) {
        ...
        var o = [];
        if (n = n || 1, e && e.length) {
            n > 1 && t > 6 && o.push('<a href="' + r(n - 1) + '" data-page="' + (n - 1) + '" >涓婁竴椤�</a>');
            for (var i = e.length,
            s = 0; i > s; s++) o.push(e[s] ? "<a " + (e[s] == n ? 'class="on"': "") + ' href="' + r(e[s]) + '" data-page="' + e[s] + '">' + e[s] + "</a>": "<span>...</span>");
            t > n && t > 6 && o.push('<a href="' + r(n + 1) + '" data-page="' + (n + 1) + '">涓嬩竴椤�</a>')
        }
        return o.join("")
    }
    function n(n) {
...
function() {
    ...
    function str(e, t) {
        ...
        case "object":
            ...
            if (rep && "object" == typeof rep) for (o = rep.length, n = 0; o > n; n += 1)"string" == typeof rep[n] && (a = rep[n], r = str(a, c), r && i.push(quote(a) + (gap ? ": ": ":") + r));
...
function() {
    function e() {
        "test" == $.env.getEnv() ? lianjiaCasManager.config({
            ...
            getFirstTicket: "http://passport.off.lianjia.com/cas/prelogin/loginTicket",
            loginUrl: "http://passport.off.lianjia.com/cas/login"
    ...
    function n() {
        if (!c) {
            ...
            "test" == $.env.getEnv() ? t.src = "http://passport.off.lianjia.com/cas/js/passport.js": "dev" === s ? t.src = "http://passport.lianjia.com:8088/cas/js/passport.js": t.src = "https://passport.lianjia.com/cas/js/passport.js",
    ...
    function o(e) {
        ...
        if ($("#userNews").length > 0) {
            var n = new $.Trans({
                url: $.env.fixedUrl("http://ajax.lianjia.com/ajax/user/favorite/getnotifynum/"),
                type: "jsonp",
                args: {
                    cityId: t
                }
            });
            n.request().done(function(t) {
                t = t && t.data,
                t && t.unread_num && e.append('<span class="login_bubble_tip">' + t.unread_num + "</span>"),
                $("#userNews").html($.template($("#News").html()).render({
                    data: t
                }))
            })
        }
    ...
    l = !1,
    s = $.env.getEnv();
    return i = "test" === s ? "http://passport.off.lianjia.com/cas/captcha.htm": "dev" === s ? "http://passport.lianjia.com:8088/cas/captcha.htm": "http://passport.lianjia.com/cas/captcha.htm",
    $(document.body).ready(function() {
        ...
        function(e) {
            ...
            if (c && c.checked && (l.remember = 1), "none" != $(".checkVerimg").css("display")) {
                var u = $(".ver-img").val();
                if (!/^\d{4}$/.test(u)) return n("楠岃瘉鐮佹牸寮忛敊璇�"),
                void $(".ver-img").focus();
                l.code = u
            }
            r(),
            t(function() {
                ...
                function(e) { - 1 == e.code ? n() : ($.listener.trigger("loginActSuccess"), window.NOTAUTOJUMP || location.reload())
                },
                function(e) {
                    1 === e.code ? n() : 2 === e.code ? (n("璇疯緭鍏ラ獙璇佺爜"), $(".checkVerimg").show(), o.trigger("click")) : 3 === e.code && (n("楠岃瘉鐮佽緭鍏ラ敊璇�"), $(".checkVerimg").show(), o.trigger("click"))
                })
            })
        })
    }),
...
function(require) {
    function e(e) {
        for (var n, a = !1,
        r = i.width(), s = window.innerHeight, c = 0, l = o.length; l > c; c++) n = o[c],
        a = t(n, e, r, s),
...
function(require) {
    ...
    function t() {
        ...
        function(e) {
            $(e.target).closest(".frauds-list,.hot-sug,.search-txt ul,.del").length || ($(".frauds-list").hide(), $(".hot-sug").hide(), p.css({
                height: "35px",
                overflow: "hidden",
                border: "0px",
                background: "none",
    ...
    function o() {
        ...
        function() {
            ...
            $.ajax({
                ...
                crossDomain: !0,
                success: function(n) {
                    0 == n.status ? (t.html("鍙嶉鎴愬姛闈炲父鎰熻阿鎮ㄧ殑鍙嶉锛�"), e.delay(2e3).fadeOut().removeClass("bounceIn"), v.delay(2e3).fadeOut()) : t.html("鍙嶉澶辫触璇烽噸鏂板～鍐欙紒")
                }
            })
        }),
        ...
        function() {
            ...
            $.ajax({
                ...
                n.html("");
                var e = e.data;
                if (e.data.length <= 0 && $("#tousu").hide(), e.data && 0 == e.code) {
                    for (var a = e.data,
                    r = "",
                    o = 0; o < a.length; o++) {
                        var i;
                        i = 1 == a[o].issue_status ? "鏈鐞�": 2 == a[o].issue_status ? "澶勭悊涓�": "宸插畬鎴�",
                        r += $.replaceTpl(t, {
    ...
    function c() {
        ...
        function() {
            ...
            if (e) if (window.loginData && 1 == window.loginData.code) window.open(e);
                ...
                var t = $(".btn-login");
                t.length > 0 ? t.trigger("click") : alert("璇风櫥褰曞悗浣跨敤锛岃阿璋紒")
            }
        })
    }
    function l(e, t) {
